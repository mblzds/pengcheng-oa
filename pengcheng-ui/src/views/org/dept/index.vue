      ...
      <n-form ref="formRef" :model="formData" :rules="rules" label-placement="left" label-width="90">
        ...
        <n-form-item label="负责人" path="leaderId">
          <div style="width: 100%">
            ...
            />
            <div v-if="!formData.id" class="form-tip">新建部门时尚无成员，请先建后再编辑指定。负责人留空时审批流会自动走父部门负责人。</div>
...
const leaderPlaceholder = computed(() => {
  ...
  if (leaderOptions.value.length === 0) return '本部门暂无成员（可留空）'
  return '请选择部门负责人'
})
